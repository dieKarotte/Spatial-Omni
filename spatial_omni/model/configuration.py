...
# NOTE: legacy spatial-encoder scaffold: this file includes additional legacy spatial-encoder config fields for the audio encoder.
# Keep these in sync with any modular generator changes when you integrate into transformers.
...
class Qwen2_5OmniTextConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.attention_dropout = attention_dropout
        self.loss_type = "ForCausalLMLoss" if loss_type is None else loss_type
...
class Qwen2_5OmniThinkerConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        seld_baseline_repo_path=None,  # Set via config or CLI
        seld_task_id="233",
        ...
        spatial_encoder_type="seld",  # "seld" | "so_backbone" | "iv" | "neural_iv"
        ...
        so_projector_type="pixel_shuffle",  # "mlp" | "mlp_ln" | "pixel_shuffle"
